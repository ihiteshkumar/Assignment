...
{    
    CGFloat val = _delegate? [_delegate carousel:self valueForOption:option withDefault:value]: value;
    return val;
}
...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            CGFloat arc = [self valueForOption:iCarouselOptionArc withDefault:M_PI * 1.2];
...
//            NSLog(@"OFFSET: %f", offset);
        ...
        case iCarouselTypeCoverFlow2:
        {
            ...
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:0.9];
            ...
            if (_vertical)
            {
                ...
                return CATransform3DRotate(transform, -clampedOffset * M_PI_2 * tilt * 2, -1.0, 0.0, 0.0);
            }
            else
            {
